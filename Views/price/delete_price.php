...
<div class="card border-secondary">
    ...
    <div class="card-body">
        <h5 class="card-title">Ви дійсно бажаєте видалити даний пункт -<b> <?=$model['name']?>?</b></h5>
        <a href="/price/deleteprice?id=<?=$model['id']?>&confirm=yes" class="btn btn-warning">Підтвердити</a>
